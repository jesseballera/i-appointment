package com.purplemango.app.aop;
...
public class DataOperationAspect {
    ...
    @Before(value = "@within(com.purplemango.app.aop.operations.BeforeGlobalMongoOperation)")
    ...
    @Before(value = "@within(com.purplemango.app.aop.operations.BeforeTenantMongoOperation)")
    ...
    @Before(value = "@within(com.purplemango.app.aop.operations.BeforeDefaultMongoOperation) || " + "@annotation(com.purplemango.app.aop.operations.BeforeDefaultMongoOperation)")
